...
Library   DataDriver    file=C:/Users/HP/PycharmProjects/PythonProject/Python advance programing/PythonProject/Robot Framework/DataDriven/ddtLogindataCSV.csv    sheet_name=ddtLogindataCSV

#test template provide a data_driven to testing by allowing a single keyword(the template)
